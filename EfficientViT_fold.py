...
PATIENCE = 4
N_SPLITS = 5
EXPERIMENT_NAME = "5fold_bismillah_EfficientViT"
MODEL_NAME = "EfficientViT-M0"
# ==================================================
...
# ==================================================
# FINAL EFFICIENTVIT TRAINING
# ==================================================
def train_final_efficentvit(
    train80_df
):
    dataset = FootDataset(
        train80_df,
...
# ==================================================
# TEST EFFICIENTVIT PREDICTION
# ==================================================
def predict_test_efficentvit(
    model,
    test_df
):
...
if __name__ == "__main__":
    ...
    (
        ...
        fold_results,
        best_fold_loss
    ) = generate_oof_efficentvit(train80_df)
    ...
    print("\nTraining Final EfficientViT...")

    final_model, train_losses = train_final_efficentvit(
        train80_df
    )
    ...
    y_true, y_pred, y_score = predict_test_efficentvit(
        final_model,
        test_df
    )
